                            ...
                            if(isset($res['message'])) {
                                switch($res['message']) {
                                    ...
                                    case 'Payer and collector cannot be the same user':
                                        ...
                                        $btn = '<a href="/my_cart.php" class="btn btn-warning">Verificar Correo</a>';
                                    break;
                                    case 'The collector does not meet the personal data verification requirements':
                                        $alert = '
                                            <div class="mx-auto w-50 alert alert-danger" role="alert">
                                                    <p>Hubo un error la conectar con MercadoPago por favor intente nuevamente</p>
                                            </div>
                                        ';
                                    break;
                                }
                ...
                <?php else :
                    ...
                    /* Return URLs */
                        ...
                        $currency = $preference->items[0]->currency_id; ?>
                            ...
                            <script>
                                const mp = new MercadoPago('<?php echo MP_PUBLIK_KEY ?>', {
                                    locale: 'es-AR'
                                });
