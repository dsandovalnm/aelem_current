            ...
            /* Aceptar cambios y recortar imagen */
                ...
                if(cropImgBtn !== null) {
                    cropImgBtn.addEventListener('click', () => {
                        cropImages(600, 'imagen_articulo_cropped');
                        cropImages(400, 'imagen_preview_cropped');
                    });
                }

                /* Funcion para recortar imagenes */
                    function cropImages(width, htmlIdElement) {
                        ...
                        canvas.toBlob( blob => {
                            ...
                            reader.onload = () => {
                                ...
                                let croppedImage = document.getElementById(htmlIdElement);
