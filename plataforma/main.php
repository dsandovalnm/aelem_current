		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p class="title text-center">Recordatorio nuevos costos suscripción mensual a partir de Mayo</p>
					<p>Nuevo Costo Argentina: <strong>$ 2000 ARS</strong></p>
					<p>Nuevo Costo Exterior: <strong>$ 20 USD</strong></p>
				</div>
